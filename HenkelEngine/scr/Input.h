...
public:
	...
	bool isStringButtonDown(const std::string& input);
	bool isStringButtonJustPressed(const std::string& input);
	bool isStringButtonJustReleased(const std::string& input);
	...
	void CreateAxisBinding(const std::string& input, SDL_GameControllerButton code, Axis axis);
	void CreateAxis2Binding(const std::string& input, SDL_Keycode code, Axis2 axis);
	void CreateAxis2Binding(const std::string& input, SDL_GameControllerButton code, Axis2 axis);
	...
	SDL_GameControllerButton GetButtonFromString(const std::string& input);
